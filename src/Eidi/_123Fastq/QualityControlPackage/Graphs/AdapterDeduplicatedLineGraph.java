...
public class AdapterDeduplicatedLineGraph extends JPanel {
    ...
    public AdapterDeduplicatedLineGraph(double[][] data, double minY, double maxY, String xLabel, String[] xTitles, int[] xCategories, String graphTitle) {
    ...
    public AdapterDeduplicatedLineGraph(double[][] data, double minY, double maxY, String xLabel, String[] xTitles, String[] xCategories, String graphTitle) {
        this.data = data;
        this.minY = minY;
        this.maxY = maxY;
