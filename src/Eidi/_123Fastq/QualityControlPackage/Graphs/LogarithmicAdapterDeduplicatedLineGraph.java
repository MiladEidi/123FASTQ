...
public class LogarithmicAdapterDeduplicatedLineGraph extends JPanel {
    ...
    public LogarithmicAdapterDeduplicatedLineGraph(double[][] data, double minY, double maxY, String xLabel, String[] xTitles, int[] xCategories, String graphTitle) {
    ...
    public LogarithmicAdapterDeduplicatedLineGraph(double[][] data, double minY, double maxY, String xLabel, String[] xTitles, String[] xCategories, String graphTitle) {
        this.data = data;
        this.minY = minY;
        this.maxY = maxY;
...
//            label = label.replaceAll(".0$", "");
            ...
            g2.drawString(label, 37, getY(y) + (g.getFontMetrics().getAscent() / 2));
        }
...
//        for (double i = yStart; i <= maxY; i += yInterval) {
        ...
        for (int i = 0; i <= 7; i += 1) {
            ...
            g2.drawLine(xOffset, getY(y), highestX * baseWidth + xOffset, getY(y));
        }
        g2.setColor(Color.BLACK);
        // Now draw the axes
